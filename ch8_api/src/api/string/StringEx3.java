...
public class StringEx3 {
    public static void main(String[] args) {
        ...
        // replace() 결과는 새로운 문자열로 반환 ( 원본을 변경하여 반환 x )
        ...
        // replaceAll() - 정규식 사용 가능 / 전체 변경
        System.out.println(str.replaceAll("[a-z]", "1")); // 안녕하세요 W1111

        str2 = "Hellollo"; // 처음 만나는 애만 변경
        ...
        // 대문자 / 소문자 변경
        str2 = "HELLo";
        System.out.println(str2.toLowerCase()); // Lower ~~~ -> 소문자 / hello
        System.out.println(str2.toUpperCase()); // Upper ~~~ -> 대문자 / HELLO

        // trim() : 양쪽 끝이 있는 공백 제거 가운데는 안해줌.
        // " Hello".equals("Hello") = false (공백포함)
        ...
        // valueOf() : 문자열로 반환
        int i = 5;
        String str4 = String.valueOf(i); // "5" 문자열로 바뀜
        str4 = i + ""; // "5"
