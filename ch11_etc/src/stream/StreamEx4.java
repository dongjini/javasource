...
public class StreamEx4 {
    public static void main(String[] args) {
        ...
        // Stream 이용
        // Function<String, ? extends R> mapper
        fruits.stream()
                .map(f -> f.toUpperCase())
                .collect(Collectors.toList()); // 대문자로 바꾼 후 수집하고 새로운 리스트로 만듦

        // Stream 생성
        // IntStream.range(0, 0)
        // of(T... values) : 가변(...이 들어가 있으면)
        // of(T t) : 하나만 넣고 만듦
        ...
        // stream
        stream.map(f -> f.getName()) // ["files1.txt", "files2.txt" ,,, ]
