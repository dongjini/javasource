...
public class StudentEx1 {
    public static void main(String[] args) {
        // Student 인스턴스 생성, 사용
        // 인스턴스 생성 시 생성자 사용함(암기)
        Student student1 = new Student();
        Student student2 = new Student(1, 5);
        Student student3 = new Student("s1234567", "홍길동", 2, 3, "010-1234-1234", "hond2@gmail.com");
        Student student4 = new Student("s1234734", "김김김", 1, 2, "010-1234-1745", "hond3@gmail.com");
        ...
        // System.out.println("이름 : " + student3.getNeme());
        ...
        // System.out.println("이름 : " + student4.getNeme());
    ...
    public static void studentInfo(Student student) {
        ...
        System.out.println("이름 : " + student.getNeme());
